 ...
 */
// #|+PRIV
// #|*IDENT=dante-routes-mgmt
// #|*NAME=Services: Dante
// #|*DESCR=Allow access to the 'Services: Dante' page.
// #|*MATCH=dante_routes_mgmt.php*
// #|-PRIV
...
if (! is_array ( $config ['installedpackages'] ['dante'] ['passroutes'] )) {
	$config ['installedpackages'] ['dante'] ['passroutes'] = array ();
}
$pass_routes = &$config ['installedpackages'] ['dante'] ['passroutes'];
...
if (isset ( $_POST ['PassSave'] ) && isset ( $_POST ['RoutesPassList_id'] )) {
	...
	if (valide_ip_cidr_fqdn ( $tmp, 'Pass', 'Routes','from' ) 
		...
		$savemsg = "Dante pkg:Pass Routes created in list.";
...
<form action="dante_routes_mgmt.php" method="post"
